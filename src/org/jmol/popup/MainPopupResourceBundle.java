...
public class MainPopupResourceBundle extends PopupResource {
  ...
  protected String[] getWordContents() {
    ...
    String[] words = new String[] {
        ...
        "help", GT._("Jmol Script Commands") ,
        "mouse", GT._("Mouse Manual") ,
        "translations", GT._("Translations") ,
        "systemMenu", GT._("System"),
        "os", Viewer.strOSName, 
        "JAVAmemTotal", "?",
        "JAVAmemMax", "?",
        "JAVAprocessors", "?",
...
//        "selectMenu", GT._("Select"),
        ...
        "atomMenu", GT._("Atoms"),
        "atomNone", GT._("Off"),
        "atom15", GT.i(GT._("{0}% van der Waals"), 15),
        "atom20", GT.i(GT._("{0}% van der Waals"), 20),
        "atom25", GT.i(GT._("{0}% van der Waals"), 25),
        "atom50", GT.i(GT._("{0}% van der Waals"), 50),
        "atom75", GT.i(GT._("{0}% van der Waals"), 75),
        "atom100", GT.i(GT._("{0}% van der Waals"), 100),

        "bondMenu", GT._("Bonds"),
        "bondNone", GT._("Off"),
        "bondWireframe", GT._("On"),
        "bond100", GT.o(GT._("{0} \u00C5"), "0.10"),
        "bond150", GT.o(GT._("{0} \u00C5"), "0.15"),
        "bond200", GT.o(GT._("{0} \u00C5"), "0.20"),
        "bond250", GT.o(GT._("{0} \u00C5"), "0.25"),
        "bond300", GT.o(GT._("{0} \u00C5"), "0.30"),
        ...
        "hbond100", GT.o(GT._("{0} \u00C5"), "0.10"),
        "hbond150", GT.o(GT._("{0} \u00C5"), "0.15"),
        "hbond200", GT.o(GT._("{0} \u00C5"), "0.20"),
        "hbond250", GT.o(GT._("{0} \u00C5"), "0.25"),
        "hbond300", GT.o(GT._("{0} \u00C5"), "0.30"),
        ...
        "ssbond100", GT.o(GT._("{0} \u00C5"), "0.10"),
        "ssbond150", GT.o(GT._("{0} \u00C5"), "0.15"),
        "ssbond200", GT.o(GT._("{0} \u00C5"), "0.20"),
        "ssbond250", GT.o(GT._("{0} \u00C5"), "0.25"),
        "ssbond300", GT.o(GT._("{0} \u00C5"), "0.30"),
        ...
        "vectorOff", GT._("Off"),
        "vectorOn", GT._("On"),
        "vector3", GT.i(GT._("{0} pixels"), 3),
        "vector005", GT.o(GT._("{0} \u00C5"), "0.05"),
        "vector01", GT.o(GT._("{0} \u00C5"), "0.10"),
        "vectorScale02", GT.o(GT._("Scale {0}"), "0.2"),
        "vectorScale05", GT.o(GT._("Scale {0}"), "0.5"),
        "vectorScale1", GT.o(GT._("Scale {0}"), "1"),
        "vectorScale2", GT.o(GT._("Scale {0}"), "2"),
        "vectorScale5", GT.o(GT._("Scale {0}"), "5"),
        ...
        "SIGNEDNOGLwriteJpg", GT.o(GT._("Export {0} image"), "JPG"),      
        "SIGNEDNOGLwritePng", GT.o(GT._("Export {0} image"), "PNG"),      
        "SIGNEDNOGLwritePngJmol", GT.o(GT._("Export {0} image"), "PNG+JMOL"),      
        "SIGNEDNOGLwriteGif", GT.o(GT._("Export {0} image"), "GIF"),    
        "SIGNEDNOGLwritePovray", GT.o(GT._("Export {0} image"), "POV-Ray"),      
        "SIGNEDwriteJmol", GT._("Save as PNG/JMOL (image+zip)"),      
        "SIGNEDwriteIsosurface", GT._("Save JVXL isosurface"),      
        "SIGNEDNOGLwriteVrml", GT.o(GT._("Export {0} 3D model"), "VRML"),      
        "SIGNEDNOGLwriteX3d", GT.o(GT._("Export {0} 3D model"), "X3D"),      
        "SIGNEDNOGLwriteIdtf", GT.o(GT._("Export {0} 3D model"), "IDTF"),      
        "SIGNEDNOGLwriteMaya", GT.o(GT._("Export {0} 3D model"), "Maya"),      
        ...
        "surfSolvent14", GT.o(GT._("Solvent Surface ({0}-Angstrom probe)"), "1.4"),
        "surfSolventAccessible14",
        GT.o(GT._("Solvent-Accessible Surface (VDW + {0} Angstrom)"), "1.4"),
        ...
        "FILEMOLload", GT.o(GT._("Reload {0}"), "(molecular)"),
        "FILEUNITone", GT.o(GT._("Reload {0}"), "{1 1 1}"),
        "FILEUNITnine", GT.o(GT._("Reload {0}"), "{444 666 1}"),
        "FILEUNITnineRestricted", GT.o(GT._("Reload {0} + Display {1}"), new Object[] { "{444 666 1}", "555" } ),
        ...
        "3p", GT.i(GT._("{0} px"), 3), 
        "5p", GT.i(GT._("{0} px"), 5),
        "10p", GT.i(GT._("{0} px"), 10),

        "byAngstromMenu", GT._("Angstrom Width"),
        "10a", GT.o(GT._("{0} \u00C5"), "0.10"),
        "20a", GT.o(GT._("{0} \u00C5"), "0.20"),
        "25a", GT.o(GT._("{0} \u00C5"), "0.25"),
        "50a", GT.o(GT._("{0} \u00C5"), "0.50"),
        "100a", GT.o(GT._("{0} \u00C5"), "1.0"),
